...
var init_app3 = __esm({
  "src/app/app.ts"() {
    ...
    init_router();
    App = class App2 {
      title = signal("minecraft-dev-bible-frontend");
    };
    App = __decorate([
      Component({
        selector: "app-root",
  ...
  "src/app/app.spec.ts"(exports) {
    ...
    describe("App", () => {
      ...
      it("should render title", () => {
        ...
        expect(compiled.querySelector("h1")?.textContent).toContain("Hello, minecraft-dev-bible-frontend");
      });
    });
  }
});
